...
class TestimonialsControllerTest < ActionController::TestCase
  ...
  test "should create testimonial" do
    assert_difference('Testimonial.count') do
      post :create, testimonial: { comment: @testimonial.comment, created_at: @testimonial.created_at, name: @testimonial.name, updated_at: @testimonial.updated_at }
    end
  ...
  test "should update testimonial" do
    put :update, id: @testimonial, testimonial: { comment: @testimonial.comment, created_at: @testimonial.created_at, name: @testimonial.name, updated_at: @testimonial.updated_at }
    assert_redirected_to testimonial_path(assigns(:testimonial))
  end
