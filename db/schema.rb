...
ActiveRecord::Schema.define(:version => 20120719120554) do
  ...
  add_index "locations", ["suburb"], :name => "index_locations_on_suburb"
  ...
  add_index "testimonials", ["name"], :name => "index_testimonials_on_name"
